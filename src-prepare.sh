...
case "${ocaml_version}" in
    4.14) true ;;
    4.13) patch -p1 -u < patches/ocaml.4.13.patch ;;
    4.11|4.12)
        patch -p1 -u < patches/ocaml.4.13.patch;
        patch -p1 -u < patches/ocaml.4.11-4.12.patch ;;
    4.10)
        patch -p1 -u < patches/ocaml.4.13.patch;
        patch -p1 -u < patches/ocaml.4.10.patch ;;
    4.09|4.08)
        patch -p1 -u < patches/ocaml.4.13.patch;
        patch -p1 -u < patches/ocaml.4.08-4.09.patch ;;
